...
class Reader(object):
    ...
    def fetch_gff(self, gff_file='../../HS_do_gff.gff3', chrom = '13', gff2bedfile='gff_2_bed.bed', feature_type = 'pseudogene', **kwargs):
        ...
        if location:
            print ("Finding SV corresponding to %s and chosen location" %(feature_type))
            ...
            bed_file = pybedtools.BedTool(gff2bedfile).merge() #usuniete merge i nagle jakby dziala?! a nie wykomentowane to nizej?
            #bed = bed_file.merge()
